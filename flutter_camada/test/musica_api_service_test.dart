...
import 'package:flutter_camada/services/musica_api_service.dart';
...
void main() {
  group('Testes da Camada MusicaApiService (GetConnect)', () {
    ...
    test('Deve inicializar o serviço com a URL base correta', () {
    ...
    test('Validação de estrutura dos dados para cadastro', () {
    ...
    test('Validação de parsing de lista de músicas recebida da API', () {
